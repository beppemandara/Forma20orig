...
// stringhe aggiunte 2017 09 28
$string['missingidnumber'] = 'Non hai inserito il numero id del corso';
$string['nome_breve_corso'] = 'Nome breve corso';
$string['nome_breve_corso_help'] = 'Il nome breve del corso viene compilato automaticamente inserendo il codice corso';
$string['result_assign_true'] = 'Assegnazione effettuata correttamente.';
$string['result_clear_true'] = 'Pulizia effettuata correttamente.';
$string['result_clear_false'] = 'Errore: Pulizia non effettuata correttamente.';
