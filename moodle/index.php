...
/// Print Section or custom info
    ...
    foreach (explode(',',$frontpagelayout) as $v) {
        switch ($v) {     /// Display the main part of the front page.
            ...
            break;
// 2017 09 29
// AKTIVE REPLY: aggiunto choice FRONTPAGEELENCOCORSIPROGRAMMATI per catalogo corsi in homepage
            case FRONTPAGEELENCOCORSIPROGRAMMATI:
                if (isloggedin()) {
                    ...
                    echo $OUTPUT->heading(get_string('corsi_programmati', 'local_f2_traduzioni', format_string(get_anno_formativo_corrente())), 2, 'headingblock header');
                    print_corsi_programmati();
                    echo html_writer::tag('span', '', array('class'=>'skip-block-to', 'id'=>'skipavailablecourses'));
                } else {
                    echo html_writer::tag('a', get_string('skipa', 'access', moodle_strtolower(get_string('availablecourses'))), array('href'=>'#skipavailablecourses', 'class'=>'skip-block'));
                    echo $OUTPUT->heading(get_string('nopermissioncourses', 'local_f2_traduzioni'), 2, 'headingblock header');
                    echo html_writer::tag('span', '', array('class'=>'skip-block-to', 'id'=>'skipavailablecourses'));
                }
            break;
// 2017 09 29
