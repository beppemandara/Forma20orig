...
class course_edit_form extends moodleform {
     ...
     */
    function definition() {
        global $CFG, $USER, $PAGE, $DB; // 2017 09 28
...
// 2017 09 28
        //AK:Reply Invertito la label shortnamecourse <-> idnumbercourse

        $mform->addElement('text','idnumber', get_string('shortnamecourse'),'maxlength="100"  size="10" onkeyup="code_number_course(); "');
        ...
        $mform->addElement('text', 'shortname', get_string('nome_breve_corso'), 'maxlength="100" size="20" title="Il nome breve del corso viene compilato automaticamente inserendo il codice corso" readonly');
        //$mform->addHelpButton('shortname', 'shortnamecourse');
        $mform->addHelpButton('shortname', 'nome_breve_corso');
// 2017 09 28
