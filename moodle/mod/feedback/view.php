...
if ( format_module_intro('feedback', $feedback, $cm->id)){
...
if ($feedback_complete_cap) {
    ...
    if ($feedback_can_submit) {
        ...
        if ($feedbackcompletedtmp) {
            ...
            echo '<a href="'.$completeurl->out().'"><button>'.get_string('continue_the_form', 'feedback').'</button></a>';
        } else {
            //echo '<a href="'.$completeurl->out().'">'.get_string('complete_the_form', 'feedback').'</a>';
            echo '<a href="'.$completeurl->out().'"><button>'.get_string('complete_the_form', 'feedback').'</button></a>';
        }
    } else {
