...
class mod_feedback_mod_form extends moodleform_mod {
	...
	$mform->addElement('selectyesno', 'consenti_compilazione_utenti', get_string('consenti_compilazione_utenti', 'feedback'));
        $mform->addHelpButton('consenti_compilazione_utenti', 'consenti_compilazione_utenti', 'feedback');
	$mform->setDefault('consenti_compilazione_utenti', 0);
