...
$string['consenti_compilazione_utenti'] = 'Consenti compilazioni studenti';
$string['consenti_compilazione_utenti_help'] = 'Abilita o disabilita la possibilità di compilazione da parte dello studente.';
$string['no_docente'] = 'Non è stato inserito il docente di riferimento non è possibile compilare il questionario.';
$string['limite_questionario_docenti'] = 'Sono già stati compilati i questionari per tutti i docenti.';
$string['limite_questionario_utenti'] = 'Limite questionari consegnati raggiunto.<br>Sono già stati compilati i questionari per tutti gli utenti.';
$string['no_permessi_questionario'] = 'Non hai i permessi per inviare il questionario.';
$string['seleziona_edizione'] = 'Selezionare una edizione.';
$string['f2_fb_info'] = 'Per annullare una risposta, effettua un doppio click sulla risposta medesima.';
