...
$capabilities = array(
	...
	/*
	 * AK-LS:
	 * DEPRECATED - sostituito con sdoppiamento di permesso in base al tipo di corso (prg, obb)
	 * 
    ...
    // Ability to add, edit, copy and delete a session (corsi programmati)
    'mod/facetoface:editsessionsprg' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
	...
	// Ability to add, edit, copy and delete a session (corsi obbiettivi)
	'mod/facetoface:editsessionsobb' => array(
		'captype' => 'write',
		'contextlevel' => CONTEXT_COURSE,
		'archetypes' => array(
			'teacher' => CAP_ALLOW,
	...
	//Il referente scuola ha la possibilità di editare 
	//soltanto le date di un'edizione
	
		'mod/facetoface:editsessionsdatesprg' => array(
		'captype' => 'write',
		'contextlevel' => CONTEXT_COURSE,
		'archetypes' => array(),
		),
