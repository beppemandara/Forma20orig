...
$string['updateattendees'] = 'Sostituisci partecipante';
...
$string['addremoveattendees'] = 'Iscrivi utenti';
$string['gestisci_iscritti'] = 'Gestisci iscritti';
...
$string['attendanceinstructions'] = 'Filtra utenti:';
...
$string['error:couldnotaddsessionteacher'] = 'Could not add session\'s teacher';
...
$string['error:couldnotupdatesessionteacher'] = 'Could not update session\'s teacher';
...
$string['facetoface:takeattendance'] = 'Inserisci dati di partecipazione';
...
$string['field:date_time_selector'] = 'Date/Time selection';
$string['field:hidden'] = 'Hidden field';
...
$string['status_user_cancelled'] = 'Sostituito';
...
$string['allenrolusers'] = 'Tutti gli utenti iscrivibili';
$string['usersprenot'] = 'Utenti prenotati/validati';
$string['substitute'] = 'Sostituisci';
$string['savenote'] = 'Salva note';
$string['sendmail'] = 'Invia mail';
$string['sendmail_auth'] = 'Invia mail autorizzazione';
$string['error:couldnotinsertstorico'] = 'Non e\' stato possibile popolare correttamente lo storico corsi';
$string['stores'] = 'Archivia';
$string['errore_assegnazione_date_chiuse'] = 'Spiecente, la funzionalità di assegnazione date delle edizioni per i referenti scuola è al momento disabilitata dall\'amministratore del sito';
$string['foglio_presenze'] = 'Foglio di presenza attività';
$string['elenco_utenti_autorizzati'] = 'Elenco utenti autorizzati';

$string['facetoface:editsessionsdatesprg'] = 'Modificare le date dell\'edizione dei corsi programmati';
$string['facetoface:editsessionsdatesobb'] = 'Modificare le date dell\'edizione dei corsi obiettivi';
$string['facetoface:editsessionsprg'] = 'Modificare l\'edizione dei corsi programmati';
$string['facetoface:editsessionsobb'] = 'Modificare l\'edizione dei corsi obiettivi';
$string['disable_sirpdata'] = 'Disabilita la data di protocollazione per lasciare l\'informazione vuota';
$string['noattendees'] = 'Non sono presenti iscritti';
$string['noattendees_booked'] = 'Non sono presenti iscritti oppure sono già stati inseriti i dati di partecipazione';
$string['attendees_booked'] = 'Clicca sul pulsante "Inserisci dati di partecipazione" per visualizzare i partecipanti';