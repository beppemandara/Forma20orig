...
class profile_field_base {
    ...
    public function edit_save_data($usernew) {
        ...
        // la seguente istruzione ètata commentata perchéestituiva NULL in ogni caso, perdendo il dato iniziale del profile_field
        //$usernew->{$this->inputname} = $this->edit_save_data_preprocess($usernew->{$this->inputname}, $data);

        $shortname_field = get_shortname_by_id($this->field->id);

        $data->userid  = $usernew->id;
        $data->fieldid = $this->field->id;
        //$data->data    = $usernew->{$this->inputname};
        $data->data = get_profile_field_value($shortname_field, $usernew->{$this->inputname});
