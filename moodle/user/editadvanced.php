...
require_once($CFG->dirroot.'/local/f2_domains/assignments/extend_user.php'); // 2017 09 29
...
// 2017 09 29
        //AK-LM: alla prima creazione dell'utente redirigo alla pag. di assegnazione domini
        if($usercreated)
            redirect ("$CFG->wwwroot/local/f2_domains/assignments/view.php?userid=$usernew->id");
        else
...
$f2ext->print_tab_edit_user('user_tab');
