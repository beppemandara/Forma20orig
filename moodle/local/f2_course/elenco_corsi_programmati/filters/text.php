 ...
 */
class course_filter_text extends courses_filter_type {
    var $_field;
     ...
     * @param string $field course table filed name
     */
    function course_filter_text($name, $label, $advanced, $field) {
        parent::courses_filter_type($name, $label, $advanced);
        $this->_field = $field;
    }
