...
$string['f2_domains:viewcompetency'] = 'View a competency';
$string['f2_domains:createcompetency'] = 'Create a competency';
$string['f2_domains:updatecompetency'] = 'Update a competency';
$string['f2_domains:deletecompetency'] = 'Delete a competency';
$string['f2_domains:createcompetencydepth'] = 'Create a competency depth';
$string['f2_domains:updatecompetencydepth'] = 'Update a competency depth';
$string['f2_domains:deletecompetencydepth'] = 'Delete a comptency depth';
$string['f2_domains:createcompetencyframeworks'] = 'Create a competency framework';
$string['f2_domains:updatecompetencyframeworks'] = 'Update a competency framework';
$string['f2_domains:deletecompetencyframeworks'] = 'Delete a competency framework';
$string['f2_domains:createcompetencytemplate'] = 'Create a competency template';
$string['f2_domains:updatecompetencytemplate'] = 'Update a competency template';
$string['f2_domains:deletecompetencytemplate'] = 'Delete a competency template';
$string['f2_domains:createcompetencycustomfield'] = 'Create a competency custom field';
$string['f2_domains:updatecompetencycustomfield'] = 'Update a competency custom field';
$string['f2_domains:deletecompetencycustomfield'] = 'Delete a competency custom field';
$string['f2_domains:assignselfposition'] = 'Assign self position';
$string['f2_domains:assignuserposition'] = 'Assign user position';
$string['f2_domains:viewposition'] = 'View a position';
$string['f2_domains:createposition'] = 'Create a position';
$string['f2_domains:updateposition'] = 'Update a position';
$string['f2_domains:deleteposition'] = 'Delete a position';
$string['f2_domains:createpositiondepth'] = 'Create a position depth';
$string['f2_domains:updatepositiondepth'] = 'Update a position depth';
$string['f2_domains:deletepositiondepth'] = 'Delete a position depth';
$string['f2_domains:createpositionframeworks'] = 'Create a position framework';
$string['f2_domains:updatepositionframeworks'] = 'Update a position framework';
$string['f2_domains:deletepositionframeworks'] = 'Delete a position framework';
$string['f2_domains:createpositioncustomfield'] = 'Create a position custom field';
$string['f2_domains:updatepositioncustomfield'] = 'Update a position custom field';
$string['f2_domains:deletepositioncustomfield'] = 'Delete a position custom field';
$string['f2_domains:vieworganisation'] = 'View an organisation';
$string['f2_domains:createorganisation'] = 'Create an organisation';
$string['f2_domains:updateorganisation'] = 'Update an organisation';
$string['f2_domains:deleteorganisation'] = 'Delete an organisation';
$string['f2_domains:createorganisationdepth'] = 'Create an organisational depth';
$string['f2_domains:updateorganisationdepth'] = 'Update an organisational depth';
$string['f2_domains:deleteorganisationdepth'] = 'Delete an organisational depth';
$string['f2_domains:createorganisationframeworks'] = 'Create an organisational framework';
$string['f2_domains:updateorganisationframeworks'] = 'Update an organisational framework';
$string['f2_domains:deleteorganisationframeworks'] = 'Delete an organisational framework';
$string['f2_domains:createorganisationcustomfield'] = 'Create an organisation custom field';
$string['f2_domains:updateorganisationcustomfield'] = 'Update an organisation custom field';
$string['f2_domains:deleteorganisationcustomfield'] = 'Delete an organisation custom field';
$string['f2_domains:assignorganisation'] = 'Assign an organisation to user';
$string['f2_domains:importorganisations'] = 'Import organisations';
...
// Login string
$string['howdoiaccessilearn'] = 'How do I access FORMA?';
...
$string['gest_assegnazione_ruoli'] = 'Gestione assegnazione ruoli referenti scuola e formativi';
