...
if(!has_capability('moodle/grade:manage', $context)){
	echo $OUTPUT->header();
	echo '<div align="center"><p class="errormessage">Spiacente, ma attualmente non avete il permesso per fare questo (Gestire elementi di valutazione)</p><p class="errorcode"></p></div>';
	echo $OUTPUT->continue_button($CFG->wwwroot.'/grade/report/user/index.php?id='.$courseid);
	echo $OUTPUT->footer();
	die;	
}
// 2017 09 29
