...
class grade_report_overview extends grade_report {
    ...
    public function setup_table() {
        ...
        if ($this->showrank['any']) {
            ...
            $tablecolumns = array('coursename','codice','grade', 'rank');
            $tableheaders = array($this->get_lang_string('coursename', 'grades'), 'Codice',
                                  $this->get_lang_string('grade'),
                                  $this->get_lang_string('rank', 'grades'));
        } else {
            $tablecolumns = array('coursename', 'Codice', 'grade');
            $tableheaders = array($this->get_lang_string('coursename', 'grades'), 'Codice',
                                  $this->get_lang_string('grade'));
        }
    ...
    public function fill_table() {
        ...
        if ($this->courses) {
            ...
            foreach ($this->courses as $course) {
                ...
                // 2017 10 02
                $data = array($course->fullname, $courselink, grade_format_gradevalue($finalgrade, $course_item, true));
