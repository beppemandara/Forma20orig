...
if (has_capability('moodle/grade:viewall', $context)) { //Teachers will see all student reports
    ...
    if ($report->fill_table()) {
// 2017 09 29
    	// Se il corso e' on-line
    	if(get_type_course($courseid)){
    		echo "<h3>".get_string('my_c_course_status', 'local_f2_traduzioni')."</h3>";
    		
    		$state_user_course = get_status_course_completion_user($USER->id,$courseid);
    		...
    		$start_date = "";
    		$end_date = "";
    		if($state_user_course->timestarted)
    			$start_date = date('d/m/Y',$state_user_course->timestarted);
    		if($state_user_course->timecompleted)
    			$end_date = date('d/m/Y',$state_user_course->timecompleted);
    		
    		echo get_string('stato_fruizione', 'local_f2_traduzioni')." = <b>".$status_corso."</b>";
    		echo "<br>";
    		echo get_string('my_c_timestart', 'local_f2_traduzioni')." = <b>".$start_date."</b>";
    		echo "<br>";
    		echo get_string('my_c_timefinish', 'local_f2_traduzioni')." = <b>".$end_date."</b>";
    	}
// 2017 09 29
        echo '<br />'.$report->print_table(true);
    }
