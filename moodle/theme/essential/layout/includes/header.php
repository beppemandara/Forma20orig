                ...
                <div class="row-fluid">
                    ...
                    <div class="pull-<?php echo ($left) ? 'right' : 'left'; ?>">
                        ...
                        <div class="nav-collapse collapse pull-<?php echo ($left) ? 'left' : 'right'; ?>">
                            ...
                            <!-- START MODIFICHE -->
                            <div id="custom_menu_programmed">
                                <?php echo $OUTPUT->custom_menu_programmed(); ?>
                            </div>
                            <div id="custom_menu_curriculum">
                                <?php echo $OUTPUT->custom_menu_curriculum(); ?>
                            </div>
                            <div id="custom_menu_reservations">
                                <?php echo $OUTPUT->custom_menu_reservations(); ?>
                            </div>
                            </div>
                            <div id="custom_menu_management">
                                <?php echo $OUTPUT->custom_menu_management(); ?>
                            </div>
                            <!-- END MODIFICHE -->
                            ...
                            <div id="custom_menu_activitystream">
                                <!-- 2017 12 22 commentato su richiesta -->
