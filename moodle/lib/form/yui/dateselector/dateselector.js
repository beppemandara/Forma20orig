YUI.add('moodle-form-dateselector', function(Y) {
    ...
    M.form.dateselector = {
        ...
        initPanel : function(config) {
            ...
            Y.one('#dateselector-calendar-panel').on('click', this.calendar_click, this); // 2017 09 29
...
// 2017 09 29
        calendar_click : function(e) {
            if (e.target._node.className.indexOf('calclose') == -1) {
//                console.log('Non ho cliccato sulla X');
                e.halt();
            } else {
