...
require_once($CFG->dirroot.'/blocks/f2_apprendimento/storico/filters/lib.php');

/**
 * Generic filter for text fields.
 */
class edition_filter_text extends editions_filter_type {
    var $_field;
     ...
     * @param string $field edition table filed name
     */
    function edition_filter_text($name, $label, $advanced, $field) {
        parent::editions_filter_type($name, $label, $advanced);
        $this->_field = $field;
    }
