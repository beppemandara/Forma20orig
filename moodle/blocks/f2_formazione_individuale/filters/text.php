<?php //$Id: text.php 979 2013-01-15 17:04:46Z c.arnolfo $

/**
 * Generic filter for text fields.
 */
class users_filter_text extends users_filter_type {
    var $_field;
     ...
     */
    function users_filter_text($name, $label, $advanced, $field) {
