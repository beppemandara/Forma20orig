...
class inserisci_daticorso_senza_determina_form extends moodleform {
  public function definition() {
    $mform =& $this->_form;
    $gestione_corsi = $this->_customdata['gest_corsi_ind_senza_determina'];    // this contains the data of this form
...
*/
        $mform->addElement('static', 'description', get_string('costo', 'block_f2_formazione_individuale'), '0');
      ...
      //$mform->addElement('checkbox', 'cassa_economale', get_string('cassa_economale', 'block_f2_formazione_individuale'));
        ...
        $where = ' AND ntemp.id = 9 ';

        $modello_mail = get_templates($data, $where, 1)->dati;
        ...
        $buttons = array(
            ...
            //,$mform->createElement('button', 'indietro', get_string('indietro', 'block_f2_formazione_individuale'),'onclick="goBack()"')
        );
