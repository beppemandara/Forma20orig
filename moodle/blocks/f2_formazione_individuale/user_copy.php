<?php
    ...
    $url = new moodle_url("{$CFG->wwwroot}/blocks/f2_formazione_individuale/user_copy.php?training=".$training."&id_course".$id_course);
    $gestionecorsi_url = new moodle_url("{$CFG->wwwroot}/blocks/f2_formazione_individuale/gestione_corsi.php?training=".$training."&id_course".$id_course);
    $PAGE->set_url($url);
    ...
    echo $OUTPUT->heading(get_string('copia_corso', 'block_f2_formazione_individuale'));
