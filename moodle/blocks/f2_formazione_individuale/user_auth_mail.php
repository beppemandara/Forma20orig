...
echo $str1;
ob_flush();
redirect(new moodle_url('/blocks/f2_formazione_individuale/gest_corsi_ind_senza_determina.php?training='.$training));
...
function createPDF($id_corso_ind) {
    ...
    //Se il tipo di notifica èFormazione Individuale Mail con spesa"
    //  ed èichiesto l'anticipo cassa economale, allora devono essere inviati anche gli allegati "cassa1" e "cassa2".
