    ...
    function get_content() {
        ...
        /// Accessibility: markup as a list.
            ...
            foreach ($discussions as $discussion) {
                ...
                // START NEW 18/01/2013
                $id_post = $discussion->id;
                $post = $DB->get_record('forum_posts', array('id'=>$id_post), '*', MUST_EXIST);
                $estrattoTot = wordwrap($post->message, 350, "<br />\n");
                $estratto_array = explode("<br />", $estrattoTot);
                $estratto = $estratto_array[0];
                $estratto = file_rewrite_pluginfile_urls($estratto, 'pluginfile.php', $context->id, 'mod_forum', 'post', $id_post);
                // END NEW
                ...
                $text .= '<li class="post">'.
                         ...
                         //'<div class="info"><a href="'.$CFG->wwwroot.'/mod/forum/discuss.php?d='.$discussion->discussion.'">'.$discussion->subject.'</a></div>'. // 2017 09 28
                         '<div class="info"><a href="'.$CFG->wwwroot.'/mod/forum/discuss.php?d='.$discussion->discussion.'">'.$discussion->subject.'</a>'.$estratto.'</div>'.
                         "</li>\n";
            }
            $text .= "</ul>\n";
