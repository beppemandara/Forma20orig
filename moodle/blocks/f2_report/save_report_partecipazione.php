...
$next_page       = optional_param('next_page','get_report_partecipazione_pentaho.php', PARAM_TEXT);
...
$baseurl = new moodle_url('/blocks/f2_report/report_partecipazione.php');
...
$form = get_report_form_partecipazione($userid,$next_page,$selected_report); // 19/02/2015
echo $form;
echo $OUTPUT->box_end();
echo $OUTPUT->footer();
