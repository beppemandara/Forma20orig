...
if($numero_report == 0) {
    ...
    $param_codice_voce_menu = '?codice_voce_menu=ISMAX';
    $param_descrizione_voce_menu = '&descrizione_voce_menu=Report iscrizione massiva';
    $param_url_pagina_di_ritorno = '&url_pagina_di_ritorno=iscrizione_massiva.php';
