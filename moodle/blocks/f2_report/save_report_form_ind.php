...
$next_page       = optional_param('next_page','get_report_form_ind_pentaho.php', PARAM_TEXT);
...
$baseurl = new moodle_url('/blocks/f2_report/report_form_ind.php');
...
$form = get_report_form_formind($userid,$next_page,$selected_report); // 06/08/2014
echo $form;
echo $OUTPUT->box_end();
echo $OUTPUT->footer();