...
if($numero_report == 0) {
    ...
    $param_codice_voce_menu = '?codice_voce_menu=GRFO';
    $param_descrizione_voce_menu = '&descrizione_voce_menu=Report Formazione online';
    $param_url_pagina_di_ritorno = '&url_pagina_di_ritorno=online/report_on_line.php';
