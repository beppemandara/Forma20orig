...
if($numero_report == 0) {
    ...
    $param_codice_voce_menu = '?codice_voce_menu=QUES';
    $param_descrizione_voce_menu = '&descrizione_voce_menu=Report questionari di gradimento';
    $param_url_pagina_di_ritorno = '&url_pagina_di_ritorno=report_questionari.php';
