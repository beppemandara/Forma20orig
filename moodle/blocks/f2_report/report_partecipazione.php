...
if($numero_report == 0) {
    ...
    $param_codice_voce_menu = '?codice_voce_menu=PART';
    $param_descrizione_voce_menu = '&descrizione_voce_menu=Report partecipazione';
    $param_url_pagina_di_ritorno = '&url_pagina_di_ritorno=report_partezipazione.php';
