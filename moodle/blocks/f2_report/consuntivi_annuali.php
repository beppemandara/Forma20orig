...
if($numero_report == 0) {
    ...
    $param_codice_voce_menu = '?codice_voce_menu=CONAN';
    $param_descrizione_voce_menu = '&descrizione_voce_menu=Report consuntivi annuali';
    $param_url_pagina_di_ritorno = '&url_pagina_di_ritorno=consuntivi_annuali.php';
    $url_pagina_no_report = $pagina_no_report.$param_codice_voce_menu.$param_descrizione_voce_menu.$param_url_pagina_di_ritorno;
    ...
    $param_descrizione_voce_menu = '&descrizione_voce_menu=Report consuntivi annuali';
    $param_url_pagina_di_ritorno = '&url_pagina_di_ritorno=consuntivi_annuali.php';
    $url_pagina_selezione_report = $pagina_selezione_report.$param_codice_voce_menu.$param_descrizione_voce_menu.$param_url_pagina_di_ritorno;
    $delay = 1;
