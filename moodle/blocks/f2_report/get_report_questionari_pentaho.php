...
//$num_param_report = get_report_num_parameter_stat($full_path_report);
$num_param_report = get_report_num_parameter_questionari($full_path_report);
...
{
	//get_report_form_stat($userid,$next_page,$full_path_report,$output_target);
	get_report_form_questionari($userid,$next_page,$full_path_report,$output_target);
}
