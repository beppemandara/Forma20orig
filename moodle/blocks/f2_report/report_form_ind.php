...
if($numero_report == 0) {
    ...
    $param_codice_voce_menu = '?codice_voce_menu=FIND';
    $param_descrizione_voce_menu = '&descrizione_voce_menu=Report formazione individuale';
    $param_url_pagina_di_ritorno = '&url_pagina_di_ritorno=report_Form_ind.php';
