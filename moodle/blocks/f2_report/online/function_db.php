...
*/
    ...
    $query = " SELECT"
            ...
            .",         visibile, monitorabile, posizione_in_report, flag_punteggio_finale"
            ." FROM     tbl_eml_pent_moduli_corsi_on_line"
            ." WHERE    id_corso = ".$id_corso
    ...
    foreach($result as $row) {
        ...
        $elenco_moduli[$numero_moduli]->flag_punteggio_finale = $row->flag_punteggio_finale;
    }
...
*/
    ...
    $query = "INSERT INTO tbl_eml_pent_moduli_corsi_on_line"
            ...
            .", istanza_modulo, nome_modulo, visibile, monitorabile, posizione_in_report, flag_punteggio_finale"
            ." ) VALUES ("
            ...
            .", ".$rec_tbl_eml_pent_moduli_corsi_on_line->flag_punteggio_finale
            .")";
    $mysqli->query($query);
    if ($mysqli->errno) {
        return -$mysqli->errno;
