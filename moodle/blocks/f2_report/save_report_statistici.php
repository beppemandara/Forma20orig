...
$next_page       = optional_param('next_page','get_report_statistici_pentaho.php', PARAM_TEXT);
...
$baseurl = new moodle_url('/blocks/f2_report/report_statistici.php');
...
$form = get_report_form_stat($userid,$next_page,$selected_report); // 15/07/2014
echo $form;
echo $OUTPUT->box_end();
echo $OUTPUT->footer();