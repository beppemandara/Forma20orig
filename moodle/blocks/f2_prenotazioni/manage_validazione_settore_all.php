...
if ($isOk == true)
{
	...
	if (isReferenteDiSettore($userid)) validazione_settore_all(); //valida tutte le prenotazioni del settore dell'anno formativo in corso
	else if (isReferenteDiDirezione($userid) or isSupervisore($userid))
	{
		validazione_settore_all($settore_id);
	}
