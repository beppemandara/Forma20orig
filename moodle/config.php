...
$CFG->dboptions = array(
    ...
    'dbport'    => '',          // the TCP port number to use when connecting
                                ...
                                //  default port
    //'logall'    => true,        // log tutte le query effettuate, da usare con parsimonia :-))
);
...
//$CFG->divertallemailsto = 'giuseppe.mandara@csi.it'; // NOT FOR PRODUCTION SERVERS!
...
$CFG->passwordsaltmain = '/rj.`/v9t _IUi;024,]r]b.q2AV/7T';
