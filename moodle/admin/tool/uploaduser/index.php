...
$STD_FIELDS = array('id', 'username', 'email',
        'city', 'country', 'orgidnumber', 'vieworgidnumber', 'lang', 'timezone', 'mailformat',
...
if ($formdata = $mform2->is_cancelled()) {
    ...
    while ($line = $cir->next()) {
        ...
        // salva l'informazione dell'assegnazione del dominio di appartenenza o di visibilità per l'utente se presente
        save_organization_assignment($user, $existinguser, $upt, $userserrors); // 2017 09 29
