<?php
    ...
    if (has_capability('moodle/user:create', $sitecontext)) {
        ...
        // 20171003
        echo '<p><a href="'.$securewwwroot.'/user/editadvanced.php?id=-1">'.get_string('addnewuser').'</a></p>';
    }
    if (!empty($table)) {
        ...
        if (has_capability('moodle/user:create', $sitecontext)) {
            //echo $OUTPUT->heading('<a href="'.$securewwwroot.'/user/editadvanced.php?id=-1">'.get_string('addnewuser').'</a>');
            // 20171003
            echo '<p><a href="'.$securewwwroot.'/user/editadvanced.php?id=-1" class="action_button"><button type="button">'.get_string('addnewuser').'</button></a></p>';
        }
    }
