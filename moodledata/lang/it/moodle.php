...
/**
 * Strings for component 'moodle', language 'it', branch 'MOODLE_27_STABLE'
 *
 * @package   moodle
...
$string['clammovedfile'] = 'Il file è stato spostato nella cartella di quarantena configurata, la nuova cartella è {$a}';
$string['clammovedfilebasic'] = 'Il file è stato spostato in una cartella di quarantena.';
$string['clamquarantinedirfailed'] = 'Non è stato possibile spostare il file nella cartella di quarantena configurata, {$a}. E\' necessario correggere la configurazione  altrimenti i file infetti saranno eliminati.';
...
$string['shortnamecourse'] = 'Codice corso';
