...
/**
 * Strings for component 'feedback', language 'it', branch 'MOODLE_27_STABLE'
 *
 * @package   feedback
...
$string['emailnotification_help'] = 'L\'amministratore ricevera\' notifiche email per ciascun feedback compilato.';
...
$string['items_are_required'] = 'L\'asterisco indica che la risposta &egrave; obbligatoria.';
...
$string['timeclose_help'] = 'La data di chiusura del feedback, a partire dalla quale le persone non potranno pi&ugrave; rispondere. Se l\'opzione non &egrave; selezionata, non ci sar&agrave; una data di chiusura.';
$string['timeopen'] = 'Apertura';
$string['timeopen_help'] = 'La data di apertura del feedback, a partire dalla quale le persone potranno rispondere. Se l\'opzione non &egrave; selezionata, non  ci sar&agrave; una data di apertura.';
