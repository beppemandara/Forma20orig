...
/**
 * Strings for component 'reservation', language 'it', branch 'MOODLE_27_STABLE'
 *
 * @package   reservation
...
$string['configlocations'] = 'In questa pagina è possibile gestire i luoghi per le prenotazioni di questo sito Moodle';
